...
from hcpa_monai import benchmark
from hcpa_monai.config import TrainConfig


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Benchmark MONAI puro (sem DALI/TIMM)")
    p.add_argument("--results", type=Path, default=Path("./results/monai_puro_bench"))
