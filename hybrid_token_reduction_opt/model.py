...
class HybridTokenReduction(nn.Module):
    ...
    def __init__(
        ...
        self.d_model = int(d_model)
        # Canais de saida da CNN (ex.: 2048). Nesta variante otimizada a selecao de
        # tokens ocorre ANTES da projecao, entao o TokenSelector opera na dimensao do
        # backbone; a projecao comprime backbone_feature_dim -> d_model em seguida.
        ...
        self.token_selector = TokenSelector(
            token_dim=self.backbone_feature_dim,
...
def create_hybrid_token_reduction_model(
    ...
    transformer_dim: dimensao de trabalho do Transformer. Se None, usa
        ...
        corta o custo por (backbone_feature_dim/transformer_dim)^2. A selecao de
        tokens ocorre na dimensao do backbone antes da projecao.
    """
