"""
Avaliação do modelo Hybrid Token Reduction Opt.
"""
...
from hybrid_token_reduction_opt.model import HybridTokenReduction
...
def main():
    ...
    print("="*70)
    print("HYBRID TOKEN REDUCTION OPT - EVALUATION")
    print("="*70)
    ...
    with open(results_file, 'w') as f:
        f.write("HYBRID TOKEN REDUCTION OPT - EVALUATION RESULTS\n")
        f.write("="*70 + "\n\n")
