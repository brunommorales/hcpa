...
for ax, gpu in zip(axes, gpus):
    ...
    for bar, mean, std in zip(bars, subset["auc_mean"] * 100, subset["auc_std"] * 100):
        ax.text(
...
# Build legend handles with colored/hatched squares
...
axes[0].set_ylabel("AUC (%)", fontsize=19)
fig.tight_layout(w_pad=0.5, rect=[0, 0, 1, 0.93])
# Dá um pouco mais de respiro à esquerda para alinhar o eixo Y com a caixa do gráfico
fig.subplots_adjust(left=0.06)
plt.savefig(
    "/home/users/bmmorales/projects/hcpa/plots_all/auc_faceted_by_gpu.png",
    dpi=300,
    bbox_inches="tight",
)
plt.savefig(
    "/home/users/bmmorales/projects/hcpa/plots_all/auc_faceted_by_gpu.pdf",
    bbox_inches="tight",
)
print("Saved: auc_faceted_by_gpu.png / .pdf")
